...
const I18N_DICT = {
  en: {
    ...
    fl_running: 'Running…',
    fl_running_desc: 'Reading persisted Alpha158 factors and 1d prices from trading.db. No account is created.',
  ...
  zh: {
    ...
    fl_run: '运行因子实验',
    fl_running: '运行中…',
    fl_running_desc: '正在从 trading.db 读取持久化 Alpha158 因子和日线价格；不会创建任何账户。',
