...
const I18N_DICT = {
  en: {
    ...
    fl_title: 'Factor Lab',
    fl_subtitle: 'Combine Alpha158 building blocks without creating an account. First test signal quality, then decide whether it deserves promotion.',
    ...
    fl_running: 'Running…',
    fl_running_desc: 'Computing temporary Alpha158-style factors from 1d OHLCV in trading.db. No account is created.',
    fl_catalog: 'Alpha158 Catalog',
  ...
  zh: {
    ...
    fl_title: '因子实验室',
    fl_subtitle: '不创建账户，直接组合 Alpha158 building blocks。先看信号质量，再决定是否值得升格成正式策略。',
    fl_builder: '因子构造器',
    ...
    fl_run: '运行因子实验',
    fl_running: '运行中…',
    fl_running_desc: '正在从 trading.db 的日线 OHLCV 临时计算 Alpha158 风格因子；不会创建任何账户。',
    fl_catalog: 'Alpha158 因子库',
