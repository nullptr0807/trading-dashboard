...
const I18N_DICT = {
  en: {
    ...
    sym_loading: 'Loading…',
    sym_pagination: 'Symbol pages',
    sym_previous_page: 'Previous page',
    sym_next_page: 'Next page',
    ...
    system_quote: 'Quotes',
    system_quote_closed: 'Market closed',
    system_extended_session: 'Extended session',
    system_extended_valuation: 'Valuations update only when fresh extended-hours prints are available',
    ...
    card_pnl: 'PnL',
    card_return: 'Return',
    card_annualized_return: 'Current Annualized',
    card_age_days: 'Running',
    days_suffix: 'd',
    card_trades: 'Trades',
    card_sharpe: 'Sharpe',
  ...
  zh: {
    ...
    system_quote: '报价',
    system_quote_closed: '休市',
    system_extended_session: '盘前 / 盘后时段',
    system_extended_valuation: '估值仅在扩展时段出现新鲜成交时更新',
    ...
    card_pnl: '盈亏',
    card_return: '收益率',
    card_annualized_return: '当前年化收益率',
    card_age_days: '运行天数',
    days_suffix: '天',
    card_trades: '交易',
    card_sharpe: '夏普率',
